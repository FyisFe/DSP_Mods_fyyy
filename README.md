...
- [DashboardOverhaul](DashboardOverhaul/) - Adds the missing multi-page UI to the in-game Dashboard: tabbed pages (switch/add/delete/rename) + move charts between pages + rename/delete a chart's statistic from the chart / 为游戏内仪表盘补全多页界面：标签页（切换/新建/删除/重命名）+ 跨页移动图表 + 在图表上重命名/删除统计项
